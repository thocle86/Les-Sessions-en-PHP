        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="/login.php" class="btn btn-primary navbar-btn" id="btn-login">Login</a>
                    </li>
                    <?php if(isset($_SESSION["login"])) {
                    echo "<li>";
                        echo "<a href='disconnect.php' class='btn btn-dark navbar-btn' id='btn-disconnect'>Disconnect</a>";
                    echo "</li>";
                    }
                    ?>
                </ul>
